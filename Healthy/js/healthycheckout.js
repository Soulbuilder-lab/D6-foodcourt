...
document.addEventListener('DOMContentLoaded', () => {
    const cartData = JSON.parse(localStorage.getItem('healthyCart')) || [];
    ...
    if (cartData.length === 0) {
        ...
        window.location.href = 'healthycart.html';
        return;
    }
    ...
    form.addEventListener('submit', (e) => {
        ...
        const orderData = {
            ...
            restaurant: 'Vitamin C',                    // Tagged for admin panel
        ...
        localStorage.removeItem('healthyCart');
        
        window.location.href = 'healthysuccess.html';
    });
});